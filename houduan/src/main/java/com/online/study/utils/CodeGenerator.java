...
public class CodeGenerator {
    private static final String DATASOURCE = "exam-demo";
    private static final String basePath = "D:\\毕设\\B站\\在线考试\\springboot\\";

    private static final String tableName = "student_paper";
    private static final String modelName = "阅卷管理";
