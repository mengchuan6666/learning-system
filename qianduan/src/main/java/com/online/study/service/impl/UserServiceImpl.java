...
import com.online.study.mapper.RoleMapper;
import com.online.study.mapper.RoleMenuMapper;
import com.online.study.mapper.UserMapper;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public void updatePassword(UserPasswordDTO userPasswordDTO) {
        ...
        int update;
        if (currentUser != null
                && (RoleEnum.ROLE_MANAGER.name().equals(currentUser.getRole())
                || RoleEnum.ROLE_ADMIN.name().equals(currentUser.getRole()))) {
            update = userMapper.updatePasswordForAdmin(userPasswordDTO);
        } else {
