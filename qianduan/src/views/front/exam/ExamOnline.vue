        ...
        <el-header height="220">
            <div style="margin: 10px 0">
                <el-input
                    ...
                    v-model="examName"
                ></el-input>
                <el-button class="ml-5" type="primary" @click="getExamInfo"
                    >搜索</el-button
                >
              ...
              (scope.row.signDesc === '' ? '': ('(' + scope.row.markDesc + ')'))
                ...
                <el-table-column align="center" label="操作">
                    <template slot-scope="scope">
                        ...
                        <!-- <el-button size="small"  @click="toViewGrade(scope.row)"
                       :icon="'el-icon-caret-right'"
                       :type="'success'">
              {{ '查成绩' }}
            </el-button> -->
        ...
        >
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button
                    ...
                    @click="
                        $router.push(
                            '/front/paper?examId=' + currentSelectedExam.id
                        )
                    "
                    >开始考试</el-button
                >
...
export default {
    ...
    methods: {
        ...
        toViewGrade(row) {
            this.$router.push('/front/grade?examId=' + row.id)
        },
        //考试类型搜索
        typeChange() {
