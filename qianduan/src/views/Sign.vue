...
<!--      <el-button type="primary" @click="handleAdd">新增 <i class="el-icon-circle-plus-outline"></i></el-button>-->
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="stateDesc" label="审核状态"></el-table-column>
      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
          <el-button type="success" v-if="scope.row.state === '00'" @click="auditSign(scope.row, '01')">审核通过</el-button>
          <el-button type="danger" v-if="scope.row.state === '00'" @click="auditSign(scope.row, '02')">审核拒绝</el-button>
          <el-popconfirm
              class="ml-5"
              confirm-button-text='确定'
              cancel-button-text='我再想想'
...
export default {
  ...
  methods: {
    ...
    auditSign(row, state) {
      ...
      this.request.patch("/sign/"+row.id + "?auditType=" + state).then(res => {
        if (res.code === '200') {
