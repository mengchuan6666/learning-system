            ...
            <el-row :gutter="30" style="margin-top: 10px">
                <el-col :span="12">
                    <el-card style="height: 500px">
                        <div ref="zyjbxx" style="width: 800px; height: 500px" />
                    </el-card>
                </el-col>
                <el-col :span="12">
                    <el-card style="height: 500px">
                        <div ref="zycsxx" style="width: 800px; height: 500px" />
                    </el-card>
                </el-col>
...
export default {
    ...
    methods: {
        ...
        listScore() {
            this.request
                .get('/echarts/homeworkScore/' + this.user.id)
                .then((res) => {
        ...
        drawJbxx() {
            ...
            this.charts1 = echarts.init(this.$refs.zyjbxx)
            let option = {
                tooltip: {
                    trigger: 'axis' // 坐标轴触发
                },
        ...
        drawLine() {
            //初始化echarts实例
            this.charts2 = echarts.init(this.$refs.zycsxx)
            let option = {
                tooltip: {
                    trigger: 'axis' 
                },
